...
export default function GeneralChat({ darkMode }) {
  ...
  return (
    <PageWrapper>
      <div
        className={`min-h-screen px-4 py-6 overflow-x-hidden ${
      ...
      >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <form
            ...
            className="mt-4 flex gap-2 items-center w-full flex-wrap sm:flex-nowrap"
          >
            <input
              value={input}
              onChange={(e) => setInput(e.target.value)}
              className={`flex-1 px-4 py-2 rounded-lg border w-full sm:w-auto
                ${
                  darkMode
            ...
            <button
              type="submit"
              className="px-4 py-2 mt-2 sm:mt-0 w-full sm:w-auto bg-blue-600 text-white rounded-lg hover:bg-blue-700"
            >
              Send
            </button>
          </form>
